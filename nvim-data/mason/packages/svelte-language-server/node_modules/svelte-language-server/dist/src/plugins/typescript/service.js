...
async function createLanguageService(tsconfigPath, workspacePath, docContext) {
    ...
    const svelteModuleLoader = (0, module_loader_1.createSvelteModuleLoader)(getSnapshot, compilerOptions, tsSystemWithPackageJsonCache, typescript_1.default);
    let svelteTsPath;
    try {
    ...
    const svelteCompiler = sveltePackageInfo.version.major >= 5
    ...
    function getSnapshotIfExists(fileName) {
        ...
        return createSnapshot(svelteModuleLoader.svelteFileExists(fileName) ? svelteFileName : fileName, doc);
    }
    ...
    function createSnapshot(fileName, doc) {
