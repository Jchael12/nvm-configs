...
class CompletionsProviderImpl {
    ...
    async getCompletions(document, position, completionContext, cancellationToken) {
        ...
        const completionItems = eventAndSlotLetCompletions;
        ...
        const addCompletion = (entry, asStore) => {
            if (isValidCompletion(entry)) {
                ...
                if (completion) {
                    completionItems.push(this.fixTextEditRange(wordRangeStartPosition, (0, documents_1.mapCompletionItemToOriginal)(tsDoc, completion)));
                }
            }
        };
