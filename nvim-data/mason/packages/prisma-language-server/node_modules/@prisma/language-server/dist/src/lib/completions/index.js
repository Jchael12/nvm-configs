...
function localCompletions(params, document, onError) {
    ...
    const foundBlock = (0, ast_1.getBlockAtPosition)(document.uri, position.line, schema);
    if (!foundBlock) {
    ...
    if ((context === null || context === void 0 ? void 0 : context.triggerKind) === vscode_languageserver_1.CompletionTriggerKind.TriggerCharacter) {
        switch (context.triggerCharacter) {
            case '@':
                ...
                return (0, attributes_1.getSuggestionForFieldAttribute)(foundBlock, (0, ast_1.getCurrentLine)(document, position.line), schema, wordsBeforePosition, document, onError);
            case '"':
            ...
            case '.':
                ...
                if (['model', 'view'].includes(foundBlock.type) && (0, ast_1.isInsideAttribute)(currentLineUntrimmed, position, '()')) {
                    ...
                    return (0, types_1.getSuggestionForNativeTypes)(foundBlock, schema, wordsBeforePosition, document, onError);
                }
        }
    }
    switch (foundBlock.type) {
        ...
        case 'type':
            ...
            return (0, attributes_1.getSuggestionForFieldAttribute)(foundBlock, foundBlock.definingDocument.getLineContent(position.line), schema, wordsBeforePosition, document, onError);
        case 'datasource':
        case 'generator':
