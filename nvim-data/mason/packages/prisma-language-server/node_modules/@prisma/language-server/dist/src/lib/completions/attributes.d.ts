 ...
 * @returns
 */
export declare function getSuggestionForFieldAttribute(block: Block, currentLine: string, schema: PrismaSchema, wordsBeforePosition: string[], document: TextDocument, onError?: (errorMessage: string) => void): CompletionList | undefined;
